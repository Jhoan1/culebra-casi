...
function onTic(Mundo){
  ...
  if(comer(Mundo,Mundo.food2)){
    if(Mundo.dir.x == 1 && frameCount%20==0){
    ...
    else if(Mundo.dir.x==-1 && frameCount%20==0){
      return update(Mundo,{ 
        food2:  ubicarComida(Mundo,Mundo.food2,Mundo.snake) , 
        snake: cons({x:(first(Mundo.snake).x)-1, y:first(Mundo.snake).y},Mundo.snake), 
        puntaje: Mundo.puntaje-1, 
    ...
    else if(Mundo.dir.y==1 && frameCount%20==0){
      return update(Mundo,{ 
        food2:  ubicarComida(Mundo,Mundo.food2,Mundo.snake) , 
        snake: cons({x:first(Mundo.snake).x, y:(first(Mundo.snake).y)+1},Mundo.snake), 
        puntaje: Mundo.puntaje-1, 
  ...
  // if (existeCerveza == false) {
  //   return update(Mundo, { 
  //       food2: setInterval(ubicarComida(Mundo,Mundo.food2,Mundo.snake)) , 
  //       snake: cons({x:(first(Mundo.snake).x)+1, y:first(Mundo.snake).y},Mundo.snake), 
  //       puntaje: Mundo.puntaje-1, 
  //       borracho:true
  //     });
